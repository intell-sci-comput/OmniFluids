...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, 
                        default='../pretrain/model/net-seed-0-K-4-modes-128-width-80-n_layers-12-output_dim-50-size-256-8_9_22_53_22.pt',
    ...
    parser.add_argument('--student_size', type=int, default=128,
            help='size of neural operator')
